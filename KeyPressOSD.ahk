Run, capslock-osd.ahk,,, cpslPid

; KeypressOSD.ahk
;--------------------------------------------------------------------------------------------------------------------------
; ChangeLog : v2.50 (2017-09-21) - robod - personal edition,
...
; Settings
    ...
    global ShowStickyModKeyCount := true
...
CreateGUI() {
    ...
    Gui, Add, Text, vHotkeyText left x10 y10
...
;    GuiControl, Move, HotkeyText, w%text_w% left
;
;    if (GuiPosition = "Top")
;        gui_y := ActWin_Y
;    else
